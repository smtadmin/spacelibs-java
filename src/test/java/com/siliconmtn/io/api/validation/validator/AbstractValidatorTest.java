...
class AbstractValidatorTest {
	...
	void testValidateUriText() throws Exception {
		...
		ValidationDTO val = ValidationDTO.builder().uriText("hello World").value("hello World").build();
	...
	void testValidateUriTextFailed() throws Exception {
		List<ValidationErrorDTO> errors = new ArrayList<>();
		ValidationDTO val = ValidationDTO.builder().uriText("hello World").value("hello World broken").build();
	...
	void testValidateOptions() throws Exception {
		...
		List<ValidationErrorDTO> errors = new ArrayList<>();
		ValidationDTO val = ValidationDTO.builder().value("VALID").validOptions(validOptions).build();
